...
class TestModuleImports:
    ...
    def test_core_modules_import(self):
        from jarvis.core import ComponentFactory, OutputManager, SystemInfo, TaskParser
    ...
    def test_dispatch_modules_import(self):
        from jarvis.dispatch import DispatchAdapter, Event, EventMerger, GoalManager
...
class TestAudioDetection:
    ...
    def test_list_audio_devices(self):
        from jarvis.voice.audio import AudioUnavailableError, list_audio_devices
